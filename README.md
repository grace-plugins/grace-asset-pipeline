...
> [!IMPORTANT]
> This repository is a fork of [Asset-Pipeline](https://github.com/wondrify/asset-pipeline), only used to support Grace Framework, but it has not been tested for Grails 5/6/7.
